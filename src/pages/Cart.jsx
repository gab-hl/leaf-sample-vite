...
function Cart() {
  ...
  return (
    <div className="lf:flex lf:min-h-full lf:flex-1 lf:flex-col lf:bg-(--lf-bg-2)">
      <main className="lf:max-w-(--lf-max-w-2xl) lf:mx-auto lf:p-(--lf-spacing-6) md:lf:p-(--lf-spacing-12)">
        <div className="lf:flex lf:flex-col lf:gap-(--lf-spacing-10)">
          <PageHeading title="Cart" description="Review line items and subtotal before continuing to checkout." />
          ...
          <div className="lf:flex lf:flex-col lf:gap-(--lf-spacing-2) lf:rounded-(--lf-shape-card) lf:border lf:border-(--lf-border-muted) lf:bg-(--lf-bg-1) lf:p-(--lf-spacing-6)">
            <div className="lf:flex lf:items-center lf:justify-between">
              <Text type="paragraph" size="medium">
                Subtotal (5 items)
              </Text>
              <Text type="small-title" size="medium">
                $360.00
              </Text>
            </div>
            <Text type="caption">
          ...
          <Button
            ...
            onClick={() => navigate('/templates/checkout')}
          >
            Checkout
          </Button>
        </div>
